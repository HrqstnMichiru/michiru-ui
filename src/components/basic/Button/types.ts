...
type ButtonVariant = "default" | "primary" | "success" | "warning" | "danger" | "info" | "purple" | "pink" | "gray";

export interface ButtonProps {
    text?: string; // 按钮文本
    icon?: any; // 图标名称
    size?: ButtonSize; // 按钮大小
    variant?: ButtonVariant; // 按钮类型/颜色
...
export interface ButtonGroupProps {
    size?: ButtonSize; // 按钮组内按钮大小
    variant?: ButtonVariant; // 按钮组内按钮类型/颜色
