...
import type { ButtonEmits, ButtonGroupContext, ButtonProps } from "./types";
import { ButtonGroupContextKey } from "./types";
...
const buttonGroupContext = inject<ButtonGroupContext | null>(ButtonGroupContextKey, null);
