...
import type { HMenuContext, HMenuItemModel, MenuNodeContext } from "./types";
import { HMenuContextKey, MenuNodeContextKey } from "./types";

const props = defineProps<HMenuItemModel>();
const tooltipRef = useTemplateRef<MTooltipInstance>("tooltipRef");
const context = inject<MenuNodeContext | null>(MenuNodeContextKey, null);
const menuContext = inject<HMenuContext | null>(HMenuContextKey, null);
...
if (props.children) {
    provide<MenuNodeContext>(MenuNodeContextKey, {
        hide: () => {
