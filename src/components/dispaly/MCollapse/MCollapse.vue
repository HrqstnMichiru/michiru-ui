...
import type { MCollapseGroupContext, MCollapseIconVariant, MCollapseProps } from "./types";
import { MCollapseGroupContextKey } from "./types";

defineOptions({
    name: "MCollapse"
});
const props = withDefaults(defineProps<MCollapseProps>(), {
    collapsed: true,
    duration: 300,
    name: undefined,
    iconVariant: "gray"
});
const context = inject<MCollapseGroupContext | null>(MCollapseGroupContextKey, null);
if (context) {
...
const colorMap: Record<MCollapseIconVariant, string> = {
    gray: "#6B6B6B",
    primary: "#409EFF",
    success: "#67C23A",
    warning: "#E6A23C",
