...
import type { MCollapseGroupContext, MCollapseGroupInstance, MCollapseGroupProps } from "./types";
import { MCollapseGroupContextKey } from "./types";

defineOptions({
    name: "MCollapseGroup"
});
const props = withDefaults(defineProps<MCollapseGroupProps>(), {
    duration: 300,
    accordion: false,
    expanded: false,
...
provide<MCollapseGroupContext>(MCollapseGroupContextKey, {
...
defineExpose<MCollapseGroupInstance>({
    expandAll,
    collapseAll
});
