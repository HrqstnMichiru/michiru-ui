<template>
    <div class="m-card" :class="[`m-card--shadow-${shadow}`, { 'm-card--blurable': blurable }]">
        <div
...
import type { CardEmits, CardIconVariant, CardProps } from "./types";
...
const colorMap: Record<CardIconVariant, string> = {
    gray: "#6B6B6B",
    primary: "#409EFF",
    success: "#67C23A",
    warning: "#E6A23C",
