...
import type { TimelineContext, TimelineItemProps } from "./types";
import { TimelineContextKey } from "./types";
...
const timelineContext = inject<TimelineContext>(TimelineContextKey);
