<template>
    <MOverlay ref="overlayRef" center @after-close="onAfterClose" :maskClosable="maskClosable" :zIndex="zIndex" transition="fade-translate">
        <div
            class="dialog"
            ...
            @click.stop>
            <div class="dialog__header" :class="{ 'dialog__header--center': center }">
            ...
            <div class="dialog__content" :class="{ 'dialog__content--center': center }">
                {{ message }}
            </div>

            <div class="dialog__footer" :class="{ 'dialog__footer--center': center }">
