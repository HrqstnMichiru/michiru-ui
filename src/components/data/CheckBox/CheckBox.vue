...
import type { CheckBoxEmits, CheckBoxGroupContext, CheckBoxProps } from "./types";
...
const groupContext = inject<CheckBoxGroupContext | null>(CheckBoxGroupContextKey, null);
if (groupContext) {
