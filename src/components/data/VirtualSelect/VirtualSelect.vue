...
import { FormContextKey, FormItemContextKey, MCheckBox, MIcon, MInput, MTag, MTooltip, MVirtualList } from "@/components";
import { computed, inject, onMounted, ref, shallowReactive, useTemplateRef } from "vue";
import type { SelectEmits } from "../Select/types";
import type { VirtualSelectProps } from "./types";

defineOptions({
    name: "MVirtualSelect"
});
const props = withDefaults(defineProps<VirtualSelectProps>(), {
    placeholder: "请选择",
    hideAfterClick: true,
    width: 250,
    placement: "bottom",
