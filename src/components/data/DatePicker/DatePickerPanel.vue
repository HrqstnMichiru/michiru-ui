...
import type { DatePickerPanelEmits, DatePickerPanelInstance, DatePickerPanelProps } from "./types";
...
const emits = defineEmits<DatePickerPanelEmits>();
...
defineExpose<DatePickerPanelInstance>({
    resetPanel,
    clearSelection,
    deleteSelection
});
