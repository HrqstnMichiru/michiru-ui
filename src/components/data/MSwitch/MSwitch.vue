...
import type { MSwitchEmits, MSwitchProps } from "./types";

defineOptions({
    name: "MSwitch"
});
const props = withDefaults(defineProps<MSwitchProps>(), {
    disabled: false,
    themeMode: false,
    variant: "primary",
});
const emits = defineEmits<MSwitchEmits>();
...
const customSize = computed(() => {
    return props.size || formItemContext?.size || "small";
});
